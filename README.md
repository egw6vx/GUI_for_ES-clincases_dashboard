...
1. Customize and download Excel template for input of clinical case and ES data
2. Upload data sources
3. Select aesthetic preferences for the dashboard figures: including maps, data tables, and longitudinal plots
